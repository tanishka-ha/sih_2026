"""
Role 2: Cross Document Verification Rules
=========================================
Performs fuzzy matching across documents (name, father_name, address),
exact match on DOB, and income consistency across application form and income certificate.
"""
